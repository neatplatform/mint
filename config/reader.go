...
// getFieldValue returns a field value as a string by checking, in order:
// command-line flags, environment variables, then file-based environment variables.
//
// If the value comes from a file, the second return value is that file path.
