...
// tokenize splits a field name into word-like tokens.
//
//	UserID       -->  User, ID
...
// getEnvVarName returns a canonical environment variable name for a field.
//
//	UserID       -->  USER_ID
...
// getFileEnvVarName returns a canonical environment variable name for value file of a field.
//
//	UserID       -->  USER_ID_FILE
...
// getFlagValue returns the value provided for a CLI flag.
//
// It supports single- and double-dash forms, with values passed either as --flag=value or --flag value.
